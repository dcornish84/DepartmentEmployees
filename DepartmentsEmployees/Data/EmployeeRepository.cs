            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        int empFirstName = reader.GetOrdinal("FirstName");
                        string firstNameValue = reader.GetString(empFirstName);

                        int empLastName = reader.GetOrdinal("LastName");
                        string lastNameValue = reader.GetString(empLastName);
